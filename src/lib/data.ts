// Deterministic mock research data for the ball-free game state reconstruction workstation.
// All values are synthetic and generated locally — no backend is connected.
...
export function teamGeometry(all: Player[], team: Team) {
  ...
  const spread =
    t.reduce((a, p) => a + Math.hypot(p.x - cx, p.y - cy), 0) / t.length;
  return {
...
export const POSSESSION_SEGMENTS = Array.from({ length: 26 }, (_, i) => {
  ...
  return {
    ...
    team: (i % 3 === 0 ? "away" : i % 4 === 0 ? "contested" : "home") as
      | Team
      | "contested",
...
export const STATE_FEATURES = [
  { key: "pressure_index", label: "Pressure Index", value: 0.412, unit: "—", type: "Model-Derived", conf: 0.78 },
  { key: "support_count", label: "Support Count (r≤12m)", value: 3, unit: "players", type: "Measured Proxy", conf: 0.95 },
  { key: "space_score", label: "Space Score", value: 0.641, unit: "—", type: "Model-Derived", conf: 0.71 },
  { key: "forward_options", label: "Forward Options", value: 4, unit: "lines", type: "Heuristic", conf: 0.66 },
  { key: "team_width_home", label: "Team Width (Home)", value: 41.8, unit: "m", type: "Measured Proxy", conf: 0.97 },
  { key: "team_length_home", label: "Team Length (Home)", value: 36.2, unit: "m", type: "Measured Proxy", conf: 0.97 },
  { key: "compactness", label: "Compactness", value: 0.548, unit: "—", type: "Heuristic", conf: 0.74 },
  { key: "def_spread", label: "Defensive Spread", value: 14.9, unit: "m", type: "Measured Proxy", conf: 0.93 },
  { key: "local_density", label: "Local Density (r≤10m)", value: 5, unit: "players", type: "Measured Proxy", conf: 0.96 },
  { key: "possessor_prob", label: "Inferred Possessor Prob.", value: 0.612, unit: "—", type: "Model-Derived", conf: 0.61 },
  { key: "transition_risk", label: "Transition Risk", value: 0.287, unit: "—", type: "Model-Derived", conf: 0.58 },
  { key: "line_break_pot", label: "Line-Break Potential", value: 0.334, unit: "—", type: "Heuristic", conf: 0.63 },
];

export const ROBUSTNESS_CONDITIONS = [
  { condition: "Reference", top1: 1.0, top3: 1.0, spearman: 1.0, kendall: 1.0, flip: 0.0, f1: 0.741 },
  { condition: "Jitter σ=0.25m", top1: 0.94, top3: 0.98, spearman: 0.93, kendall: 0.85, flip: 0.06, f1: 0.732 },
  { condition: "Jitter σ=0.50m", top1: 0.88, top3: 0.96, spearman: 0.87, kendall: 0.77, flip: 0.12, f1: 0.714 },
  { condition: "Jitter σ=1.00m", top1: 0.74, top3: 0.9, spearman: 0.76, kendall: 0.64, flip: 0.26, f1: 0.681 },
  { condition: "Dropout 5%", top1: 0.91, top3: 0.97, spearman: 0.9, kendall: 0.8, flip: 0.09, f1: 0.722 },
  { condition: "Dropout 15%", top1: 0.72, top3: 0.86, spearman: 0.71, kendall: 0.58, flip: 0.28, f1: 0.652 },
  { condition: "Dropout 25%", top1: 0.55, top3: 0.74, spearman: 0.58, kendall: 0.44, flip: 0.45, f1: 0.581 },
  { condition: "Fragmentation 0.4", top1: 0.68, top3: 0.83, spearman: 0.68, kendall: 0.53, flip: 0.32, f1: 0.634 },
];
...
export const PIPELINE = [
  ...
  { id: 5, name: "Counterfactual Ranking", state: "partial", detail: "MRR 0.583 · hypothetical only" },
