...
export const Route = createFileRoute("/benchmark")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Robustness Benchmark — Ball-Free Game State Reconstruction" },
      {
  ...
  return (
    <>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Panel title="Degradation Curve" subtitle="Possession F1 against normalised perturbation severity">
          <LineSeries
      ...
      <Panel title="Reading the Benchmark" className="mt-4">
        <ul className="list-disc space-y-1.5 pl-4 text-[11.5px] leading-relaxed text-muted-foreground">
          <li>
            Top-1 retention degrades roughly linearly with dropout but non-linearly with coordinate jitter
            beyond σ = 0.5 m.
          </li>
          <li>
            Rank correlation stays above 0.7 for all mild conditions, meaning the ordering of mid-ranked
            options is more stable than the identity of the single best option.
          </li>
          <li>
