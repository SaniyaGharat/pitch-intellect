  ...
  return (
    <>
      ...
      <div className="grid gap-4 xl:grid-cols-[1.1fr_1fr]">
        <Panel title="State Feature Matrix" subtitle="Frame-level features with provenance and confidence">
        ...
        <div className="space-y-4">
          <Panel title="Pressure Map" subtitle="Opponent-proximity pressure field, per player">
            <Pitch players={players} selectedId={sel.id} onSelect={setSelectedPlayer} heat height={320} />
          </Panel>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        <Panel title="Support Graph" subtitle={`Teammates of #${sel.number} ${sel.name} within 25 m`}>
          <table className="w-full text-[11.5px]">
            <thead>
              <tr className="border-b border-border text-left">
